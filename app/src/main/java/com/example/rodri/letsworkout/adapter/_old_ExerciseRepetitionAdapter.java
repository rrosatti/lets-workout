 ...
 */
public class _old_ExerciseRepetitionAdapter extends ArrayAdapter<ExerciseRepetition> {
    ...
    public _old_ExerciseRepetitionAdapter(Activity activity, int textViewResourceId, List<ExerciseRepetition> exercises) {
